...
``` {r figure1, echo = FALSE, fig.align = "left", fig.cap = "**Figure 1.** Streams and lakes monitoring locations, Great Basin National Park. (M. Lehman, NPS)"}
...
reactable(dplyr::select(bmi.discrepancies, -LabNotes),
          ...
          details = colDef(
            name = "Notes",
            details = function(index) {
              bmi.discrepancies$LabNotes[index]
            }
          ),
          resizable = TRUE,
          compact = TRUE,
