...
title: "Mojave Desert Network Streams and Lakes Protocol 2009-2020"
subtitle: |
...
include_graphics(here::here("figures", "STLK Map 600DPI.jpg"))
```
...
## Code Availability
All of the code used in the preparation of this data package is available in the MOJN Streams and Lakes R Package.
...
The published CSV files are provided in a raw for that suitable for use with the MOJN Streams and Lakes R package. In three cases, a CSV file is provided that contains calculated values that were generated using this R package. These files are clearly labelled as "calculated".

## Summary of datasets created.
One data package containing multiple csv data tables was published for this project:

* **`r params$dataPackage1Title`.** Comma-separated text files are Site,	Visit,	BMI	Channel,	Chemistry,	Clarity,	LakeLevelString,	LakeLevelSurvey,	WaterQualityDO,	WaterQualitypH,	WaterQualitySpCond,	WaterQualityTemperature,	WQStreamXSection,	LakeLevel_CALCULATED,	WaterQuality_CALCULATED,	WQStreamXSection_CALCULATED. These data were compiled by the Mojave Desert Inventory and Monitoring Network and were last updated on September 1, 2021. Available at `r paste0("https://irma.nps.gov/DataStore/Reference/Profile/", params$dataPackage1RefID)`. 
...
reactable(wq.stream.sanity, searchable = TRUE,
            details = colDef(
              name = "Notes",
...
reactable(wq.lake.sanity, searchable = TRUE,
            details = colDef(
              name = "Notes",
              details = function(index) {
