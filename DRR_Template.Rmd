...
kable(Table, 
      ...
      caption="**Table 1.** CSV data files in this data package.") %>%
...
# Usage Notes
A MOJN Streams and Lakes R Package that is designed to work with the datasets in their published format is available on GitHub. This package was used to implement the quality checks that are included in this report and to generate the three calculated datasets that in cluded in this data package.
