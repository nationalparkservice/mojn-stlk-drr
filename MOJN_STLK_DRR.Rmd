...
```{r Table1, echo=FALSE, fig.cap = capTab("File names and descriptions of published CSVs accompanying this data release report. There are ten raw files and and additional three calculated files.")}
...
``` {r dpl.check, warning = FALSE, fig.cap = capTab("Records with data still labeled as Raw or Provisional.")}
...
``` {r benchmark.elevations, fig.cap = capTab("Calculated elevations for each lake benchmark and water surface since 2018 when the use of digital level surveys began.")}
...
benchmark.qc$AverageElevation_ft <- round(benchmark.qc$AverageElevation_ft, 3)
...
``` {r lake.elevations, fig.cap = capTab("Calcuated lake water surface elevations.")}
...
# Acknowledgements
The authors would like to acknowledge Geoff Moret, who developed the Streams and Lakes protocol and set in motion over a decade of surface water resource monitoring in Great Basin National Park. We would also like to thank Lise Grace for providing review and editing assistance on this data release report.
